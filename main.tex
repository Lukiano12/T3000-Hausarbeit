...
Ziel dieser Hausarbeit ist es, das Fahrantriebskonzept auf den 415-38 Fahrzeug umzubauen und in Betrieb zu nehmen, um zu sehen, ob die gewünschten Verbesserungen erzielt werden.


In dem zukünftigen T07/T08 Fahrzeug soll nur eine Fahrpumpe angwendet werden (Geräuschreduktion) mit einem Schwenkwinkelsensor

\begin{figure}[H]
    \includegraphics[width=1\linewidth]{images/Gannt_Chart.png}\\[1ex]
    \centering
...
verwendete Programme für das Projekt (Visio, Excel, Zuken E3,\dots)
\clearpage
...
Aufgaben meines Teilprojektes beinhalten die Dokumentation der Bauteile (Datenblätter, Verkabelungsinfos, weitere nötigen Komponenten hierfür)
Tatsächliche Besorgung der Bauteilen.  Informationsammulng bei Kollegen, welche Komponenten vorhanden sind, was muss noch kommen, ausbuchen der Bauteile über SAP,\dots
Umbau des Fahrzeugs, anpassung der komponenten für den umbau und Installation der komponenten im fahrzeug, 
Installation der BPC sOFTWARE and das bpc controller für anwendung im Fahrzeug 
Inbetriebnahme des Fahrzeugs (mehr Information muss gesammelt werden, was bei der Inbetriebnahme gemacht wird, damit dies mehr ergänzt werden kann in der Arbeit anstatt nur Inbetriebnahme zu schreiben)

arbeit mit claus vogt, pinning, einbau, hardware als auch softwareseitiges Arbeit, software für steuergeräte etc.
